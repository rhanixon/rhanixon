        ...
        <div className="boxed2">
          <div className="bio-item">
            ...
            <h3 className="oneandquarter">
              ...
              on the New York Times Spelling Bee game developed in 3 weeks.
              Deployed on Heroku and designed with React Native, React Hooks,
              Redux, Express, PostgreSQL, and Socket.io. UI/UX with interactive
              data visualizations using React Native and D3. Back-end
              architecture written in TypeScript. Algorithm to generate
              solutions for all possible puzzles within 2 seconds created using
              bitmaps and linear algebra.
            </h3>
            <a
              className="zero"
            ...
            <a className="one" href="https://github.com/hive-mind-fs/hive-mind">
              <h3>
            ...
            <h3 className="oneandquarter">
              A fully functional e-commerce web application developed in 9 days
              using React-Redux, Node, Express, PostgreSQL, Google OAuth, and
              Stripe integration. RESTful API routes enable a persistent
